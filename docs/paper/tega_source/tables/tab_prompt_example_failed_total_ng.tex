\begin{table*}[ht] % table* は twocolumn 用
    ...
    \begin{tabular}{@{}p{2.5cm}p{12cm}@{}}
        ...
        prompt: birdhouse\newline
        prediction: A black and white artistic object\\
        \midrule
        \textbf{GPT-4 Answer} &
        2 \\
        \midrule
        ...
        \bottomrule
    \end{tabular}
    \caption{The process of consistency filtering in TeGA. Captions and prompts are evaluated by GPT-4 and by word-matching. Both of evaluation are judged to be low.}
    \label{tab:prompt_examples_failed_total_ng}
\end{table*}