...
record = {'command': [prior['command'][0], '-m', 'pytest', 'tests', '-q', '-ra', '-p',
                      ...
                      '--basetemp', '/tmp/metafind_corpus_20260908_final_cpu'],
          'environment': prior['environment'], 'started_at': time.time(),
          'source_sha256': hashes()}
log = root/'docs/audit/reproduction_corpus_20260908_final_cpu.log'
...
(root/'docs/audit/reproduction_corpus_20260908_final_cpu_execution.json').write_text(json.dumps(record, indent=2)+'\n')
