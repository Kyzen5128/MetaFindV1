...
source = Path(os.environ.get("METAFIND_EXCLUSION_LEDGER", "/home/kyzen/metafind/metafind_data/outputs/annotation_exclusions.json"))
ex = json.loads(source.read_bytes())
...
ann = paths.ANNOTATIONS.resolve(); out = ann.parent / "annotations_v10_excluded"
